...
PICS = (environ.get('PICS', 'https://graph.org/file/4c24d428cccd6fafa4a9b.jpg')).split()
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+zqXC21BVw9JiZDQ9") #[ without @ ]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '0').split()]
